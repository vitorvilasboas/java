/*
 * jqGauges v3.8.7.0 (http://www.jqchart.com)
 ...
 */
(function(a){
    a.fn.jqLinearGauge=function(b,d,e){
        if(typeof b==="object")
            d=b;
        else if(typeof b==="string"){
            b=b.toLowerCase();
            if(a.fn.jqLinearGauge.methods[b])
                return a.fn.jqLinearGauge.methods[b].call(this,d,e);
            else 
                a.error("Method "+method+" does not exist on jQuery.jqLinearGauge")
            }
