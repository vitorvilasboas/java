...
(function (h) {
    ...
    r(q.prototype, {defaultColorAxisOptions: {lineWidth: 0, gridLineWidth: 1, tickPixelInterval: 72, startOnTick: !0, endOnTick: !0, offset: 0, marker: {animation: {duration: 50}, color: "gray",
            ...
            i(b.dataClasses, function (b, h) {
                ...
                d.push(b);
                if (!b.color)
                    f.dataClassColor === "category" ? (i = c.options.colors, b.color = i[e++], e === i.length && (e = 0)) : b.color = a.tweenColors(l(f.minColor),
            ...
            if (b)
                this.left = c = b.attr("x"), this.top = d = b.attr("y"), this.width = e = b.attr("width"), this.height = b = b.attr("height"), this.right = a.chartWidth -
            ...
            this.legendColor = {linearGradient: {x1: b[0], y1: b[1], x2: b[2], y2: b[3]}, stops: a.stops || [[0, a.minColor], [1, a.maxColor]]}
            ...
            if (a)
                f = this.toPixels(a.value), f < g ? f = g - 2 : f > g + j && (f = g + j + 2), a.plotX = f, a.plotY = this.len - f, k.prototype.drawCrosshair.call(this, b, a), a.plotX = d, a.plotY = e, !c && this.cross && this.cross.attr({fill: this.crosshair.color}).add(this.labelGroup)
    ...
    h = {pointAttrToOptions: {stroke: "borderColor", "stroke-width": "borderWidth", fill: "color", dashstyle: "dashStyle"}, pointArrayMap: ["value"], axisTypes: ["xAxis", "yAxis", "colorAxis"], optionalAxis: "colorAxis", trackerGroups: ["group",
            ...
            i(this.data, function (e) {
                var f = e[d];
                if (f = f === null ? a : c && f !== void 0 ? c.toColor(f, e) : e.color || b.color)
                    e.color = f
            })
        }};
