...
(function () {
    ...
    Lb.prototype = {wrapColor: function (a) {
            if (this.color >= a)
                this.color = 0
                ...
                a && {init: function (b) {
                        ...
                        a.fn.highcharts = function () {
                            ...
                            if (this[0]) {
                                ...
                                if (c !==
                                        r)
                                    c.chart = c.chart || {}, c.chart.renderTo = this[0], new P[a](c, b[1]), d = this;
    ...
    J && J.init.call(J, Bb);
    var nb = Q.adapterRun, ac = Q.getScript, wa = Q.inArray, q = Q.each, Cb = Q.grep, bc = Q.offset, xa = Q.map, A = Q.addEvent, R = Q.removeEvent, N = Q.fireEvent, cc = Q.washMouseEvent, ob = Q.animate, eb = Q.stop, Q = {enabled: !0, x: 0, y: 15, style: {color: "#606060", cursor: "default",
            fontSize: "11px"}};
    F = {colors: "#7cb5ec,#434348,#90ed7d,#f7a35c,#8085e9,#f15c80,#e4d354,#8085e8,#8d4653,#91e8e1".split(","), symbols: ["circle", "diamond", "square", "triangle", "triangle-down"], lang: {loading: "Loading...", months: "January,February,March,April,May,June,July,August,September,October,November,December".split(","), shortMonths: "Jan,Feb,Mar,Apr,May,Jun,Jul,Aug,Sep,Oct,Nov,Dec".split(","), weekdays: "Sunday,Monday,Tuesday,Wednesday,Thursday,Friday,Saturday".split(","), decimalPoint: ".", numericSymbols: "k,M,G,T,P,E".split(","),
        ...
        title: {text: "Chart title", align: "center", margin: 15, style: {color: "#333333", fontSize: "18px"}}, subtitle: {text: "", align: "center", style: {color: "#555555"}}, plotOptions: {line: {allowPointSelect: !1, showCheckbox: !1, animation: {duration: 1E3}, events: {}, lineWidth: 2, marker: {lineWidth: 0, radius: 4, lineColor: "#FFFFFF", states: {hover: {enabled: !0}, select: {fillColor: "#FFFFFF", lineColor: "#000000", lineWidth: 2}}}, point: {events: {}}, dataLabels: y(Q, {align: "center", enabled: !1, formatter: function () {
                ...
                return this.name
            }, borderColor: "#909090", borderRadius: 0, navigation: {activeColor: "#274b6d", inactiveColor: "#CCC"}, shadow: !1, itemStyle: {color: "#333333", fontSize: "12px", fontWeight: "bold"}, itemHoverStyle: {color: "#000"},
    ...
    Z.prototype = {init: function (a, b) {
            ...
            if (f) {
                ...
                h[p] ? a = h[p].attr("id") : (g.id = a = "highcharts-" + Ab++, h[p] = i = d.createElement(f).attr(g).add(d.defs), i.stops = [], q(k, function (a) {
                    ...
                    a = d.createElement("stop").attr({offset: a[0],
                        "stop-color": j, "stop-opacity": l}).add(i);
                    i.stops.push(a)
                }));
        ...
        hide: function () {
            ...
            if (a) {
                ...
                for (e = 1; e <= i; e++) {
                    f = g.cloneNode(0);
                    h = i * 2 + 1 - 2 * e;
                    W(f, {isShadow: "true", stroke: a.color || "black", "stroke-opacity": k * e, "stroke-width": h,
    ...
    ka.prototype = {Element: Z, init: function (a, b, c, d, e) {
        ...
        destroy: function () {
            ...
            var k = this.label(a, b, c, i, null, null, null, null, "button"), j = 0, l, m, n, p, u, o, a = {x1: 0, y1: 0, x2: 0, y2: 1}, e = y({"stroke-width": 1, stroke: "#CCCCCC", fill: {linearGradient: a, stops: [[0, "#FEFEFE"], [1, "#F6F6F6"]]},
            ...
            if (h)
                ...
                }, k = a.match(i)[1], a = Tb[k], g = this.image(k).attr({x: b, y: c}), g.isImg = !0, a ? j(g, a) : (g.attr({width: 0, height: 0}), $("img", {onload: function () {
            ...
            function j() {
                ...
                if (t(bb) && o &&
                        (a === "center" || a === "right"))
                    b += {center: 0.5, right: 1}[a] * (bb - o.width);
                if (b !== p.x || c !== p.y)
    ...
    Wa = ka;
    v(Z.prototype, {htmlCss: function (a) {
            var b = this.element;
                ...
                if (b.tagName === "SPAN") {
                    ...
                    if (m !== this.cTT) {
                        ...
                        if (i > l && /[ \-]/.test(b.textContent || b.innerText))
                            E(b, {width: l + "px", display: "block", whiteSpace: "normal"}), i = l;
    ...
    v(ka.prototype, {html: function (a, b, c) {
            ...
            d.attr({text: a, x: s(b), y: s(c)}).css({position: "absolute", whiteSpace: "nowrap", fontFamily: this.style.fontFamily,
                    ...
                    if (this.parentGroup = a) {
                        if (b = a.div, !b) {
                            ...
                            q(k.reverse(), function (a) {
                                ...
                                d = b.style;
                                v(a, {translateXSetter: function (b, c) {
                                        d.left = b + "px";
                                        a[c] = b;
                                        a.doTransform = !0
    ...
    var fb, ea;
    if (!ca && !ja)
        P.VMLElement = ea = {init: function (a, b) {
            ...
            getSpanCorrection: function (a, b, c, d, e) {
                ...
                c.style[b] = a
            }}, ea = ga(Z, ea), ea.prototype.ySetter = ea.prototype.widthSetter = ea.prototype.heightSetter = ea.prototype.xSetter, ea = {Element: ea, isIE8: Da.indexOf("MSIE 8.0") > -1, init: function (a, b, c, d) {
                var e;
                this.alignedObjects = [];
            ...
            clipRect: function (a, b, c, d) {
                ...
                return v(e, {members: [], left: (f ? a.x : a) + 1, top: (f ? a.y : b) + 1, width: (f ? a.width : c) - 1, height: (f ? a.height : d) - 1, getCSS: function (a) {
    ...
    Za.prototype = {addLabel: function () {
            ...
            this.isFirst = k;
            this.isLast = j;
            b = a.labelFormatter.call({axis: a, chart: c, isFirst: k, isLast: j, dateTimeLabelFormat: l, value: a.isLog ? ha(oa(f)) :
                f});
            ...
            if (m && G)
                t === "inside" && (G = -G), d.opposite && (G = -G), h = this.getMarkPath(z, y, G, m * D, g, f), n ? n.animate({d: h, opacity: c}) : this.mark = f.path(h).attr({stroke: x, "stroke-width": m, opacity: c}).add(d.axisGroup);
            if (i && !isNaN(z))
    ...
    P.PlotLineOrBand.prototype = {render: function () {
            ...
            if (h) {
                if (p = b.getPlotLinePath(l, h), r = {stroke: q, "stroke-width": h}, m)
                    r.dashstyle = m
            } else if (j) {
                k = w(k, b.min - d);
                i = z(i, b.max + d);
            ...
            if (n)
                if (p)
                    n.animate({d: p}, null, n.onGetPath);
                else {
    ...
    L.prototype = {defaultOptions: {dateTimeLabelFormats: {millisecond: "%H:%M:%S.%L", second: "%H:%M:%S", minute: "%H:%M", hour: "%H:%M", day: "%e. %b", week: "%e. %b", month: "%b '%y", year: "%Y"}, endOnTick: !1, gridLineColor: "#C0C0C0", labels: Q, lineColor: "#C0D0E0", lineWidth: 1, minPadding: 0.01, maxPadding: 0.01, minorGridLineColor: "#E0E0E0", minorGridLineWidth: 1, minorTickColor: "#A0A0A0", minorTickLength: 2, minorTickPosition: "outside",
        ...
        defaultLeftAxisOptions: {labels: {x: -15, y: null}, title: {rotation: 270}}, defaultRightAxisOptions: {labels: {x: 15, y: null}, title: {rotation: 90}}, defaultBottomAxisOptions: {labels: {x: 0, y: 20}, title: {rotation: 0}}, defaultTopAxisOptions: {labels: {x: 0, y: -15}, title: {rotation: 0}}, init: function (a, b) {
            ...
            if (G)
                b = a.getLinePath(G), a.axisLine ? a.axisLine.animate({d: b}) : a.axisLine = e.path(b).attr({stroke: f.lineColor, "stroke-width": G, zIndex: 7}).add(a.axisGroup), a.axisLine[w ? "show" : "hide"]();
            if (j && w)
    ...
    v(L.prototype, {getPlotBandPath: function (a, b) {
    ...
    Xa.prototype = {init: function (a, b) {
            ...
            if (this.hasDragged > 10) {
                ...
                this.selectionMarker && f && (d -= m, this.selectionMarker.attr({width: M(d),
                    x: (d > 0 ? 0 : d) + m}));
            ...
            if (b)
                E(b.container, {cursor: b._cursor}), b.cancelClick = this.hasDragged > 10, b.mouseIsDown = this.hasDragged = this.hasPinched = !1, this.pinchDown = []
    ...
    v(P.Pointer.prototype, {pinchTranslate: function (a, b, c, d, e, f) {
    ...
    if (X.PointerEvent || X.MSPointerEvent) {
        var ya = {}, Ib = !!X.PointerEvent, gc = function () {
            ...
            for (a in ya)
                ya.hasOwnProperty(a) && b.push({pageX: ya[a].pageX, pageY: ya[a].pageY, target: ya[a].target});
            return b
        }, Jb = function (a, b, c, d) {
            a = a.originalEvent || a;
            if ((a.pointerType === "touch" || a.pointerType === a.MSPOINTER_TYPE_TOUCH) && aa[sa])
                d(a), d = aa[sa].pointer, d[b]({type: c, target: a.currentTarget, preventDefault: na, touches: gc()})
        };
        v(Xa.prototype, {onContainerPointerDown: function (a) {
                Jb(a,
        ...
        colorizeItem: function (a, b) {
            ...
            if (l || m) {
                ...
                if (i) {
                    ...
                    a.box = i = c.rect(0, 0, g, h, k.borderRadius, l || 0).attr({stroke: k.borderColor, "stroke-width": l || 0, fill: m || Y}).add(d).shadow(k.shadow), i.isNew = !0;
                i[f ? "show" : "hide"]()
            }
            a.legendWidth = g;
            a.legendHeight = h;
            ...
            e > d && (e = d);
            if (e > 0)
                b !== r && Ya(b, this.chart), this.nav.attr({translateX: k, translateY: f +
                            this.padding + 7 + this.titleHeight, visibility: "visible"}), this.up.attr({fill: e === 1 ? g : h}).css({cursor: e === 1 ? "default" : "pointer"}), i.attr({text: e + "/" + d}), this.down.attr({x: 18 + this.pager.getBBox().width, fill: e === d ? g : h}).css({cursor: e === d ? "default" : "pointer"}), c = -c[e - 1] + this.initialItemY, this.scrollGroup.animate({translateY: c}), this.currentPage = e, this.positionCheckboxes(c)
        }};
    Q = P.LegendSymbolMixin = {drawRectangle: function (a, b) {
    ...
    va.prototype = {init: function (a, b) {
        ...
        adjustTickAmounts: function () {
            ...
            if (c && (c.css({width: (f.width || g) + "px"}).align(v({y: 15}, f), !1, "spacingBox"), !f.floating && !f.verticalAlign))
                b = c.getBBox().height;
        ...
        getChartSize: function () {
            ...
            if (j)
                f ? f.animate(x) : this.plotBackground = b.rect(p, u, o, q, 0).attr({fill: j}).add().shadow(a.plotShadow);
            if (l)
                h ? h.animate(x) : this.plotBGImage = b.image(l, p, u, o, q).add();
            r ? r.animate({width: s.width,
                height: s.height}) : this.clipRect = b.clipRect(s);
            if (m)
                g ? g.animate(g.crisp({x: p, y: u, width: o, height: q})) : this.plotBorder = b.rect(p, u, o, q, 0, -m).attr({stroke: a.plotBorderColor, "stroke-width": m, fill: Y, zIndex: 1}).add();
            this.isDirtyBox = !1
    ...
    za.prototype = {init: function (a, b, c) {
            this.series = a;
    ...
    K.prototype = {isCartesian: !0, type: "line",
        pointClass: za, sorted: !0, requireSorting: !0, pointAttrToOptions: {stroke: "lineColor", "stroke-width": "lineWidth", fill: "fillColor", r: "radius"}, axisTypes: ["xAxis", "yAxis"], colorCounter: 0, parallelArrays: ["x", "y"], init: function (a, b) {
        ...
        }, drawLegendSymbol: Q.drawLineMarker, setData: function (a, b, c, d) {
            ...
            if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData)
                ...
                if (p && h > p) {
                    ...
                    for (c = 0; c < h; c++)
                        if (a[c] !== r && (i = {series: e}, e.pointClass.prototype.applyOptions.apply(i, [a[c]]), e.updateParallelArrays(i, c), m && i.name))
                            l.names[i.x] = i.name;
                Oa(s[0]) && qa(14, !0);
                e.data = [];
                e.options.data = a;
                ...
                for (f = b.length; f--; )
                    if (g = b[f], d = S(g.plotX), e = g.plotY, j = g.graphic, i = g.marker || {}, a = p && i.enabled === r || i.enabled, m = c.isInsidePlot(s(d), e, c.inverted), a && e !== r && !isNaN(e) && g.y !== null)
                        if (a =
                            ...
                            j[m ? "show" : "hide"](!0).animate(v({x: d - h, y: e - h}, j.symbolName ? {width: 2 * h, height: 2 * h} : {}));
                        else {
                            if (m && (h > 0 || k))
    ...
    Rb.prototype = {destroy: function () {
            ...
            var c = this.axis, d = c.chart, e = d.inverted, f = this.isNegative, g = c.translate(c.usePercentage ? 100 : this.total, 0, 0, 0, 1), c = c.translate(0),
                    c = M(g - c), h = d.xAxis[0].translate(this.x) + a, i = d.plotHeight, f = {x: e ? f ? g : g - c : h, y: e ? i - h - b : f ? i - g - c : i - g, width: e ? c : b, height: e ? b : c};
            if (e = this.label)
    ...
    v(va.prototype, {addSeries: function (a, b, c) {
            var d, e = this;
            a && (b = o(b, !0),
            ...
            if (!this.loadingShown)
                E(c, {opacity: 0, display: "", left: this.plotLeft + "px", top: this.plotTop + "px", width: this.plotWidth + "px", height: this.plotHeight + "px"}), ob(c, {opacity: d.style.opacity}, {duration: d.showDuration || 0}), this.loadingShown = !0
    ...
    v(za.prototype, {update: function (a,
                b, c) {
    ...
    v(K.prototype, {addPoint: function (a, b, c, d) {
            ...
            var c = this.chart, d = this.type, e = C[d].prototype, f, a = y(this.userOptions, {animation: !1, index: this.index, pointStart: this.xData[0]}, {data: this.options.data},
            a);
            this.remove(!1);
            for (f in e)
    ...
    v(L.prototype, {update: function (a, b) {
    ...
    var ta = ga(K, {type: "area", getSegments: function () {
            ...
            if (this.options.stacking && !this.cropped) {
                ...
                q(c, function (a) {
                    if (!j || g[a] && g[a].y !== null)
                        g[a] ? b.push(g[a]) : (h = d.translate(a), l = f[a].percent ? f[a].total ? f[a].cum * 100 / f[a].total : 0 : f[a].cum, i = e.toPixels(l, !0), b.push({y: null, plotX: h, clientX: h, plotY: i, yBottom: i, onMouseOver: na}))
                });
                b.length && a.push(b)
            } else
    ...
    C.area = ta;
    T.spline = y(J);
    Aa = ga(K, {type: "spline", getPointSpline: function (a, b, c) {
    ...
    ta = ta.prototype;
    Aa = ga(Aa, {type: "areaspline", closedStacks: !0, getSegmentPath: ta.getSegmentPath, closeSegment: ta.closeSegment,
    ...
    Aa = ga(K, {type: "column", pointAttrToOptions: {stroke: "borderColor", fill: "color",
    ...
    ta = ga(K, {type: "scatter", sorted: !1, requireSorting: !1, noSharedTooltip: !0, trackerGroups: ["markerGroup"], takeOrdinalPosition: !1, singularTooltips: !0, drawGraph: function () {
            this.options.lineWidth && K.prototype.drawGraph.call(this)
        }});
    C.scatter = ta;
    T.pie = y(J, {borderColor: "#FFFFFF", borderWidth: 1, center: [null, null], clip: !1, colorByPoint: !0, dataLabels: {distance: 30, enabled: !0, formatter: function () {
    ...
    J = {type: "pie", isCartesian: !1, pointClass: ga(za, {init: function () {
            ...
            }}), requireSorting: !1, noSharedTooltip: !0, trackerGroups: ["group", "dataLabelsGroup"], axisTypes: [], pointAttrToOptions: {stroke: "borderColor", "stroke-width": "borderWidth", fill: "color"}, singularTooltips: !0, getColor: na, animate: function (a) {
        ...
        }, drawLegendSymbol: Q.drawRectangle, getCenter: ea.getCenter, getSymbol: na};
    J = ga(K, J);
    C.pie = J;
            ...
            a.dlProcessOptions && a.dlProcessOptions(d), i = a.plotGroup("dataLabelsGroup", "data-labels", "hidden", d.zIndex || 6), !a.hasRendered && o(d.defer, !0) && (i.attr({opacity: 0}), A(a, "afterAnimate", function () {
                ...
                if (l && !e)
                    ...
                    if (l)
                        ...
                        l = {fill: d.backgroundColor, stroke: d.borderColor,
                            "stroke-width": d.borderWidth, r: d.borderRadius || 0, rotation: e, padding: d.padding, zIndex: 1};
                        for (n in l)
                            l[n] === r && delete l[n];
                ...
                if (Ba(U) === 0 || this.verifyDataLabelOverflow(U))
                    this.placeDataLabels(), u && g && q(this.points, function (b) {
                        ...
                        if ((r = b.dataLabel) && r._pos)
                            A = r._attr.visibility, y = r.connX, z = r.connY, k = j ? ["M", y + (x[6] === "left" ? 5 : -5), z, "C", y, z, 2 * x[2] - x[4], 2 * x[3] - x[5], x[2], x[3], "L", x[4], x[5]] : ["M", y + (x[6] === "left" ? 5 : -5), z, "L", x[2], x[3], "L", x[4], x[5]], i ? (i.animate({d: k}), i.attr("visibility", A)) : b.connector = i = a.chart.renderer.path(k).attr({"stroke-width": g, stroke: e.connectorColor || b.color || "#606060", visibility: A}).add(a.dataLabelsGroup);
                        else if (i)
    ...
    var gb = P.TrackerMixin = {drawTrackerPoint: function () {
            ...
            k ? k.attr({d: d}) : (a.tracker = h.path(d).attr({"stroke-linejoin": "round", visibility: a.visible ? "visible" : "hidden", stroke: p, fill: c ? p : Y, "stroke-width": b.lineWidth + (c ? 0 : 2 * i), zIndex: 2}).add(a.group), q([a.tracker,
    ...
    v(pb.prototype, {setItemEvents: function (a, b, c, d, e) {
            var f = this;
    ...
    F.legend.itemStyle.cursor =
            "pointer";
    v(va.prototype, {showResetZoom: function () {
    ...
    v(za.prototype, {select: function (a, b) {
            ...
            var c = this.plotX, d = this.plotY, e = this.series, f = e.options.states, g = T[e.type].marker && e.options.marker, h = g &&
                    !g.enabled, i = g && g.states[a], k = i && i.enabled === !1, j = e.stateMarkerGraphic, l = this.marker || {}, m = e.chart, n = e.halo, p, a = a || "";
            ...
            if (!(a === this.state && !b || this.selected && a !== "select" || f[a] && f[a].enabled === !1 || a && (k || h && i.enabled === !1) || a && l.states && l.states[a] && l.states[a].enabled === !1)) {
                if (this.graphic)
                    g = g && this.graphic.symbolName && p.r, this.graphic.attr(y(p, g ? {x: c - g, y: d - g, width: 2 * g, height: 2 * g} : {})), j && j.hide();
                else {
                    if (a && i)
                        if (g = i.radius, l = l.symbol || e.symbol, j && j.currentSymbol !==
                                l && (j = j.destroy()), j)
                            j[b ? "animate" : "attr"]({x: c - g, y: d - g});
                        else if (l)
    ...
    v(K.prototype, {onMouseOver: function () {
    ...
    v(L.prototype, {beforeSetTickPositions: function () {
        ...
        getExtendedPositions: function () {
            ...
            if (!c[d])
                f = {series: [], getExtremes: function () {
                    ...
                    }, options: {ordinal: !0}, val2lin: L.prototype.val2lin}, q(this.series, function (c) {
                    g = {xAxis: f, xData: c.xData, chart: a, destroyGroupedData: na};
                    g.options = {dataGrouping: b ? {enabled: !0, forced: !0, approximation: "open", units: [[b.unitName, [b.count]]]} :
                                {enabled: !1}};
    ...
    var ba = K.prototype, J = Hb.prototype, hc = ba.processData, ic = ba.generatePoints, jc = ba.destroy, kc = J.tooltipHeaderFormatter, lc = {approximation: "average", groupPixelWidth: 2, dateTimeLabelFormats: Kb("millisecond", ["%A, %b %e, %H:%M:%S.%L", "%A, %b %e, %H:%M:%S.%L", "-%H:%M:%S.%L"], "second", ["%A, %b %e, %H:%M:%S", "%A, %b %e, %H:%M:%S", "-%H:%M:%S"], "minute", ["%A, %b %e, %H:%M", "%A, %b %e, %H:%M", "-%H:%M"],
        ...
        ohlc: {approximation: "ohlc", groupPixelWidth: 5}}, Xb = [["millisecond", [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]], ["second", [1, 2, 5, 10, 15, 30]], ["minute", [1, 2, 5, 10, 15, 30]], ["hour", [1, 2, 3, 4, 6, 8, 12]], ["day", [1]], ["week", [1]], ["month", [1, 3, 6]], ["year", null]], Na = {sum: function (a) {
            var b = a.length, c;
            if (!b && a.hasNulls)
                c = null;
            else if (b)
    ...
    J = ga(J, {type: "candlestick", pointAttrToOptions: {fill: "color", stroke: "lineColor", "stroke-width": "lineWidth"}, upColorProp: "fill", getAttribs: function () {
    ...
    T.flags = y(T.column, {dataGrouping: null, fillColor: "white", lineWidth: 1, pointRange: 0, shape: "flag", stackDistance: 12, states: {hover: {lineColor: "black", fillColor: "#FCFFC5"}},
        style: {fontSize: "11px", fontWeight: "bold", textAlign: "center"}, tooltip: {pointFormat: "{point.text}<br/>"}, threshold: null, y: -30});
    C.flags = ga(C.column, {type: "flags", sorted: !1, noSharedTooltip: !0, takeOrdinalPosition: !1, trackerGroups: ["markerGroup"], forceCrop: !0, init: K.prototype.init, pointAttrToOptions: {fill: "fillColor", stroke: "color", "stroke-width": "lineWidth", r: "radius"}, translate: function () {
            C.column.prototype.translate.apply(this);
            ...
            for (k = c.length; k--; )
                if (j = c[k], a = j.plotX > this.xAxis.len, e = j.plotX + (a ? m : -m), l = j.stackIndex, i = j.options.shape || g.shape, f = j.plotY, f !== r && (f = j.plotY + h + m - (l !== r && l * g.stackDistance)), n = l ? r : j.plotX + m, o = l ? r : j.plotY, l = j.graphic, f !== r &&
                        e >= 0 && !a)
                    a = j.pointAttr[j.selected ? "select" : ""] || b, l ? l.attr({x: e, y: f, r: a.r, anchorX: n, anchorY: o}) : j.graphic = d.label(j.options.title || g.title || "A", e, f, i, n, o, g.useHTML).css(y(g.style, j.style)).attr(a).attr({align: i === "flag" ? "left" : "center", width: g.width, height: g.height}).add(this.markerGroup).shadow(g.shadow), j.tooltipPos = [e, f];
                else if (l)
                    j.graphic = l.destroy()
    ...
    v(F, {navigator: {handles: {backgroundColor: "#ebe7e8", borderColor: "#b2b1b6"}, height: 40, margin: 25, maskFill: "rgba(128,179,236,0.3)", maskInside: !0, outlineColor: "#b2b1b6", outlineWidth: 1, series: {type: C.areaspline === r ? "line" : "areaspline", color: "#4572A7", compare: null, fillOpacity: 0.05, dataGrouping: {approximation: "average", enabled: !0, groupPixelWidth: 2, smoothed: !0, units: J}, dataLabels: {enabled: !1, zIndex: 2},
            ...
            barBorderColor: "#bfc8d1", buttonArrowColor: "#666", buttonBackgroundColor: "#ebe7e8", buttonBorderColor: "#bbb", buttonBorderRadius: 0, buttonBorderWidth: 1, minWidth: 6, rifleColor: "#666", trackBackgroundColor: "#eeeeee", trackBorderColor: "#eeeeee", trackBorderWidth: 1, liveRedraw: ca && !cb}});
    yb.prototype = {drawHandle: function (a, b) {
                ...
                if (!(l.translate(d, !0) - l.translate(c, !0) < e.xAxis[0].minRange)) {
                    ...
                    if (!this.rendered) {
                        if (A) {
                            ...
                            if (!r.maskInside)
                                this.rightShade = f.rect().attr({fill: r.maskFill}).add(l);
                            this.outline = f.path().attr({"stroke-width": B, stroke: r.outlineColor}).add(l)
                        }
                        if (q)
                            this.scrollbarGroup = j = f.g("scrollbar").add(), m = t.trackBorderWidth, this.scrollbarTrack = n = f.rect().attr({x: 0, y: -m % 2 / 2, fill: t.trackBackgroundColor, stroke: t.trackBorderColor, "stroke-width": m, r: t.trackBorderRadius || 0, height: p}).add(j), this.scrollbar = m = f.rect().attr({y: -H %
                                        2 / 2, height: p, fill: t.barBackgroundColor, stroke: t.barBorderColor, "stroke-width": H, r: I}).add(j), this.scrollbarRifles = f.path().attr({stroke: t.rifleColor, "stroke-width": 1}).add(j)
                    }
                    e = e.isResizing ? "animate" : "attr";
                    if (A) {
                        this.leftShade[e](r.maskInside ? {x: g + b, y: y, width: c - b, height: v} : {x: g, y: y, width: b, height: v});
                        if (this.rightShade)
                            this.rightShade[e]({x: g + c, y: y, width: h - c, height: v});
                        this.outline[e]({d: ["M", i, E, "L", g + b + C, E, g + b + C, E + D, "L", g + c - C, E + D, "L", g + c - C, E, i + k, E].concat(r.maskInside ? ["M", g + b + C, E, "L", g + c - C, E] :
                            [])});
                        this.drawHandle(b + C, 0);
                        this.drawHandle(c + C, 1)
                    }
                    if (q && j)
                        this.drawScrollbarButton(0), this.drawScrollbarButton(1), j[e]({translateX: i, translateY: s(E + v)}), n[e]({width: k}), g = p + b, h = a - H, h < x && (F = (x - h) / 2, h = x, g -= F), this.scrollbarPad = F, m[e]({x: S(g) + H % 2 / 2, width: h}), x = p + b + a / 2 - 0.5, this.scrollbarRifles.attr({visibility: a > 12 ? "visible" : "hidden"})[e]({d: ["M", x - 3, p / 4, "L", x - 3, 2 * p / 3, "M", x, p / 4, "L", x, 2 * p / 3, "M", x + 3, p / 4, "L", x + 3, 2 * p / 3]});
                    this.scrollbarPad = F;
                    this.rendered = !0
                }
            }
                ...
                if (t > h && t < h + g + k)
                    if ((h = !a.scrollbarEnabled || t < h + g) && V.abs(s - e - o) < w)
                        ...
                        if (f < 0)
                            ...
                            f = p - r, v = c.dataMax;
                        if (f !== e)
                            a.fixedWidth = r, e = c.toFixedRange(f, f + r, null, v), d.setExtremes(e.min, e.max, !0, !1, {trigger: "navigator"})
                    }
            };
            ...
            f.xAxis, {id: "navigator-x-axis", isX: !0, type: "datetime", index: n, height: g, offset: 0, offsetLeft: e, offsetRight: -e, keepOrdinalPadding: !0, startOnTick: !1, endOnTick: !1, minPadding: 0, maxPadding: 0, zoomEnabled: !1})), a.yAxis = d = new L(b, y(f.yAxis, {id: "navigator-y-axis", alignTicks: !1, height: g, offset: 0, index: p, zoomEnabled: !1})), m || f.series.data ? a.addBaseSeries() : b.series.length === 0 && O(b, "redraw", function (c, d) {
                ...
                c.call(b, d)
            })) : a.xAxis = c = {translate: function (a,
                        c) {
            ...
            if (!a || b.dataMin !== null)
                return{dataMin: o(d && d.min, (t(b.dataMin) && t(c.dataMin) ? z : o)(b.dataMin, c.dataMin)), dataMax: o(d && d.max, (t(b.dataMax) && t(c.dataMax) ? w : o)(b.dataMax, c.dataMax))}
            ...
            if (a && this.navigatorOptions.adaptToUpdatedData !== !1)
                A(a, "updatedData", this.updatedDataHandler), a.userOptions.events = v(a.userOptions.event, {updatedData: this.updatedDataHandler})
    ...
    F.lang = y(F.lang, {rangeSelectorZoom: "Zoom",
    ...
    zb.prototype = {clickButton: function (a, b) {
            ...
            l.offset += k.width + 5;
            this[a + "DateBox"] = j = e.label("", l.offset).attr({padding: 2, width: f.inputBoxWidth || 90, height: f.inputBoxHeight || 17, stroke: f.inputBoxBorderColor || "silver", "stroke-width": 1}).css(y({textAlign: "center", color: "#444"}, d, f.inputStyle)).on("click", function () {
                b[a + "Input"].focus()
            }).add(l);
            ...
            i.onfocus = function () {
                E(this, {left: l.translateX + j.x + "px", top: l.translateY + "px", width: j.width - 2 + "px", height: j.height - 2 + "px", border: "2px solid silver"})
            };
            i.onblur = function () {
            ...
            if (!c.rendered && (c.zoomText = e.text(g.rangeSelectorZoom, p, d.plotTop - 20).css(i.labelStyle).add(), r = p + c.zoomText.getBBox().width + 5, q(c.buttonOptions, function (a, b) {
                ...
                c.div = j = $("div", null, {position: "relative",
                    height: 0, zIndex: 1}), f.parentNode.insertBefore(j, f), c.inputGroup = j = e.g("input-group").add(), j.offset = 0, c.drawInput("min"), c.drawInput("max");
    ...
    P.StockChart = function (a, b) {
        ...
        a.series = null;
        a = y({chart: {panning: !0, pinchType: "x"}, navigator: {enabled: !0}, scrollbar: {enabled: !0}, rangeSelector: {enabled: !0}, title: {text: null, style: {fontSize: "16px"}}, tooltip: {shared: !0, crosshairs: !0}, legend: {enabled: !1}, plotOptions: {line: f, spline: f, area: f, areaspline: f, arearange: f, areasplinerange: f, column: g, columnrange: g, candlestick: g,
                ohlc: g}}, a, {_stock: !0, chart: {inverted: !1}});
        a.series = c;
        return new va(a, b)
    };
    O(Xa.prototype, "init", function (a, b, c) {
    ...
    O(L.prototype, "drawCrosshair", function (a, b, c) {
        ...
        if (t(this.crosshair.label) && this.crosshair.label.enabled && t(c)) {
            ...
            if (!j)
                j = this.crossLabel = a.renderer.label().attr({align: f.align || (b ? "center" : h ? this.labelAlign === "right" ? "right" : "left" : this.labelAlign ===
                            "left" ? "left" : "center"), zIndex: 12, height: b ? 16 : r, fill: f.backgroundColor || this.series[0] && this.series[0].color || "gray", padding: o(f.padding, 2), stroke: f.borderColor || null, "stroke-width": f.borderWidth || 0}).css(v({color: "white", fontWeight: "normal", fontSize: "11px", textAlign: "center"}, f.style)).add();
    ...
    O(K.prototype, "render", function (a) {
        if (this.isCartesian && this.chart.options._stock)
            this.clipBox ? this.chart[this.sharedClipKey] && this.chart[this.sharedClipKey].attr({width: this.xAxis.len, height: this.yAxis.len}) : (this.clipBox = y(this.chart.clipBox), this.clipBox.width = this.xAxis.len, this.clipBox.height = this.yAxis.len);
        a.call(this)
    });
    v(P, {Axis: L, Chart: va, Color: Fa, Point: za, Tick: Za, Renderer: Wa, Series: K, SVGElement: Z, SVGRenderer: ka, arrayMin: Ra, arrayMax: Ba, charts: aa, dateFormat: ua,
        format: Ja, pathAnim: Bb, getOptions: function () {
            return F
        }, hasBidiBug: Yb, isTouchDevice: cb, numberFormat: Ia, seriesTypes: C, setOptions: function (a) {
            F = y(!0, F, a);
            Mb();
            return F
        }, addEvent: A, removeEvent: R, createElement: $, discardElement: Sa, css: E, each: q, extend: v, map: xa, merge: y, pick: o, splat: ma, extendClass: ga, pInt: I, wrap: O, svg: ca, canvas: ja, vml: !ca && !ja, product: "Highstock", version: "2.0.1"})
})();
