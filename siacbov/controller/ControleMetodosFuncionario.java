...
public class ControleMetodosFuncionario implements ControleMetodosComuns {
    ...
    public void cadastrar(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
         ...
         Logger.getLogger(ControleMetodosFuncionario.class.getName()).log(Level.SEVERE, null, ex);
         }
    }
    ...
    public void excluir(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(acessoBDDestinatario.listarPorFuncionario(id) != null){
            request.setAttribute("mensagem", "Funcionario NÃO pode ser excluido. Existem destinatário vinculados.");
            request.getRequestDispatcher("principal?d=forms&a=buscar&f=funcionario").forward(request, response);
        } else if (!acessoBDFuncionario.excluirDAO(id)){
            request.setAttribute("mensagem", "Erro ao tentar excluir o Funcionario.");
            request.getRequestDispatcher("principal?d=forms&a=buscar&f=funcionario").forward(request, response);
        } else {
...
//            f = acessoBDFuncionario.buscarPorIdDAO(id2);
    ...
    public void detalhar(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        Funcionario resultado = acessoBDFuncionario.buscarPorIdDAO(Integer.parseInt(request.getParameter("id")));
        if (resultado != null) {
            request.setAttribute("detalhesfunc", resultado);
